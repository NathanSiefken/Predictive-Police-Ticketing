...
Tree_pred = predict(Tree1, newdata=test) # Test our Predictions for out 5 leaf tree
Tree_rmse <- RMSE(test$Frequency, Tree_pred) # Create our RMSE
Tree_rmse # Print RMSE for leaf tree
