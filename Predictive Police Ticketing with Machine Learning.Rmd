...
We illiminate the few rows that have NAs and we arrive at our clean data set.
...
I was able to utilize the Longitude and Latitude coordinates with a cluster map and a heat map. Since, I was unable to display these reactive maps on a PDF, I used shiny to create a web-based dashboard completely in R. You can find it at the following URL:
<p>
